...
const Page403 = () => {
  return (
    <div className="bg-[#233142] fixed top-0 left-0 bottom-0 right-0">
      <svg
        version="1.1"
      ...
      <h1 className="text-[#facf5a] text-center mt-[-100px] mb-5 text-8xl">
        403
      </h1>
      <h2 className="text-[#455d7a] text-center text-3xl uppercase">
        Not this time, access forbidden!
      </h2>
      <h2 className="text-white text-center text-3xl uppercase mt-4">
